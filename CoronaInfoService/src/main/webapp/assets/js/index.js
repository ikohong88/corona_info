$(function() {
    ...
    $.ajax({
        ...
        success:function(r) {
            console.log(r);
            console.log(r.data[0].firstCnt+"|"+r.data[0].secondCnt);
            console.log(r.data[1].firstCnt+"|"+r.data[1].secondCnt);
            console.log(r.data[1].firstCnt+"|"+r.data[1].secondCnt);
            console.log(r.data[2].firstCnt+"|"+r.data[2].secondCnt);
            console.log(r.data[3].firstCnt+"|"+r.data[3].secondCnt);
            console.log(r.data[4].firstCnt+"|"+r.data[4].secondCnt);                            
            console.log(r.data[6].firstCnt+"|"+r.data[6].secondCnt);
            console.log(r.data[7].firstCnt+"|"+r.data[7].secondCnt);
            console.log(r.data[8].firstCnt+"|"+r.data[8].secondCnt);
            console.log(r.data[9].firstCnt+"|"+r.data[9].secondCnt);
            console.log(r.data[10].firstCnt+"|"+r.data[10].secondCnt);
            console.log(r.data[11].firstCnt+"|"+r.data[11].secondCnt);
            console.log(r.data[12].firstCnt+"|"+r.data[12].secondCnt);
            console.log(r.data[13].firstCnt+"|"+r.data[13].secondCnt);
            console.log(r.data[14].firstCnt+"|"+r.data[14].secondCnt);
            console.log(r.data[15].firstCnt+"|"+r.data[15].secondCnt);
            console.log(r.data[16].firstCnt+"|"+r.data[16].secondCnt);
            console.log(r.data[17].firstCnt+"|"+r.data[17].secondCnt);
            ...
            let confirmed_chart = new Chart (ctx4, {
                ...
                data:{
                    ...
                    datasets:[{
                        label:"여성/남성",
                        data:[
                            r.data[0].confCase-r.data[1].confCase,
                            r.data[2].confCase-r.data[3].confCase],
                        backgroundColor:['rgba(255,30,30,0.7)','rgba(0,0,255,0.4)']                
                    }]
                }
            })
    ...
    $.ajax({
        ...
        success:function(r) {
            console.log(r);
            let totalDeath = 
            (r.data[4].death-r.data[5].death)+
            (r.data[6].death-r.data[7].death)+
            (r.data[8].death-r.data[9].death)+
            (r.data[10].death-r.data[11].death)+
            (r.data[12].death-r.data[13].death)+
            (r.data[14].death-r.data[15].death)+
            (r.data[16].death-r.data[17].death)+
            (r.data[18].death-r.data[19].death)+
            (r.data[20].death-r.data[21].death);
            let totalconfCase = 
            (r.data[4].confCase-r.data[5].confCase)+
            (r.data[6].confCase-r.data[7].confCase)+
            (r.data[8].confCase-r.data[9].confCase)+
            (r.data[10].confCase-r.data[11].confCase)+
            (r.data[12].confCase-r.data[13].confCase)+
            (r.data[14].confCase-r.data[15].confCase)+
            (r.data[16].confCase-r.data[17].confCase)+
            (r.data[18].confCase-r.data[19].confCase)+
            (r.data[20].confCase-r.data[21].confCase);    
            let ctx3 = $("#age_chart");
